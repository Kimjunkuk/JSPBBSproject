...
<body> 
	...
	<div>
		<input type='button' value='Assignment(과제) ex1' style='width:100%; margin-bottom:10px;' onclick="location.href='ex1.jsp'"/>
		<input type='button' value='Assignment(과제) ex2' style='width:100%; margin-bottom:10px;' onclick="location.href='ex2.jsp'"/>
		<input type='button' value='Assignment(과제) ex3' style='width:100%; margin-bottom:10px;' onclick="location.href='ex3.jsp'"/>
